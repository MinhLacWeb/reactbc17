...
class Quanlydanhsachphim extends Component {
  data = [
    {
      maPhim: 1283,
      tenPhim: "Trainwreck",
  ...
  renderFilm = () => {
    let result = this.data.map((film, index) => {
      return (
        <div className="col-2 mt-5" key={film.id}>
          <div className="card">
            <img src={film.hinhAnh} alt="" height={300} />
      ...
      >
        ...
        >
          <nav
            ...
            style={{ backgroundColor: "rgba(200,100,200,0.5)" }}
          >
...
export default Quanlydanhsachphim;
